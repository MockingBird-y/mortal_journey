...
export class ConditionEvaluator {
  ...
  private registerDefaults(): void {
    ...
    this.register("周围敌人越多", () => true);

    this.register("周围敌人", () => true);

    this.register("根据自身护盾值", (ctx) => ctx.actor.shield > 0);

    this.register("根据敌方中毒人数", () => true);
    ...
    this.register("队友死亡时", () => true);

    this.register("队友死亡后", () => true);

    this.register("敌方死亡时", () => true);

    this.register("即死效果", () => true);

    this.register("敌人无法清除中毒且每回合叠加", () => true);

    this.register("敌人因中毒受到伤害时", () => true);

    this.register("敌人中毒时", () => true);
    ...
    this.register("受到致命伤时", () => true);

    this.register("死亡时", () => true);

    this.register("重复攻击自己的敌人", () => true);

    this.register("攻击随机目标两次", () => true);

    this.register("释放时概率不进入冷却", () => true);

    this.register("储存一次技能", () => true);

    this.register("随机重置", () => true);
