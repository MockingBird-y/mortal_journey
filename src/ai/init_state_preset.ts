...
5. intro 规则：
  ...
  5.2 禁止在 intro 中使用"体修""法修""剑修""毒修""通用""灵力""劲力""体魄"等体系或属性分类名词。
  5.3 不得描述功法的具体功能效果，应采用修仙世界的玄学化描述风格。
  5.4 示例："据传源自上古力修一脉，修炼时周身气血如山岳崩裂"。
6. system（体系）字段：只能从以下五种中选择一个：通用、剑修、体修、法修、毒修。体系须与功法名称和描述契合，参考如下：
   - 通用：万法归宗，不拘一格，物理法术兼修（如长春功、聚灵诀、混元功）。
   - 剑修：御剑杀伐，以剑为道，物理爆发为主（如御剑法、青莲剑歌、斩仙剑诀）。
   - 体修：淬炼肉身，以力破万法，物理近战为主（如崩山诀、金刚不坏功、龙象诀）。
   - 法修：五行术法，驾驭天地灵气，法术远程为主（如烈火术、冰魄法、天雷法）。
   - 毒修：以毒入道，炼蛊施毒，持续消耗为主（如万毒诀、化骨术、噬魂蛊法）。
7. role（定位）字段：
