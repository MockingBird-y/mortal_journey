...
每条建议须具体（禁止"继续探索""谨慎行事"等空话），以"你"或主角姓名为主语，符合修仙世界观与主角当前境界。
示例：<MJ_ACTION_OPTIONS_TAG>{"aggressive":"你主动向张师兄请教外门修炼法门，争取早日突破","moderate":"你先熟悉杂务处的日常，边做工边打听宗门规矩","cautious":"你默默观察周遭同门的来历与修为，不急于与人结交","veryCautious":"你藏拙低调，先摸清七玄门的派系与禁忌再作打算"}</MJ_ACTION_OPTIONS_TAG>
`;
