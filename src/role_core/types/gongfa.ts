...
export const GONGFA_EFFECT_CATALOG: Readonly<Record<GongfaSystem, Readonly<Record<ItemGrade, readonly GongfaSpecialEffect[]>>>> = {
  ...
  "通用": {
    ...
    "中品": [
      { name: "元气破", mpCost: [75, 70], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [60, 800], scalingRatio: [0.75, 2.5], scalingStat: "strength" }], type: "主动" },
      { name: "灵爆术", mpCost: [10, 70], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [60, 800], scalingRatio: [1.0, 4.0], scalingStat: "perception" }], type: "主动" },
      { name: "净化术", mpCost: [12, 80], cooldown: 2, battleEffects: [{ type: "cleanse" }], type: "主动" },
      { name: "定身术", mpCost: [12, 80], cooldown: 2, battleEffects: [{ type: "applyCc", ccType: "stun", chance: [0.25, 0.45], duration: 1 }], type: "主动" },
      { name: "灼烧术", mpCost: [12, 80], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [50, 700], scalingRatio: [0.6, 2.5], scalingStat: "perception" }, { type: "applyStatus", statusType: "burn", tickValue: [30, 300], isPercent: false, duration: 3, maxStacks: 3 }], type: "主动" },
    ...
    "上品": [
      { name: "元气斩魂", mpCost: [18, 130], cooldown: 4, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [100, 1200], scalingRatio: [1.2, 5.0], scalingStat: "strength" }], type: "主动" },
      { name: "灵元爆发", mpCost: [18, 130], cooldown: 4, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [100, 1200], scalingRatio: [1.2, 5.0], scalingStat: "perception" }], type: "主动" },
      { name: "驱散术", mpCost: [20, 140], cooldown: 4, battleEffects: [{ type: "dispel" }], type: "主动" },
      { name: "真实打击", mpCost: [18, 130], cooldown: 4, battleEffects: [{ type: "dealDamagePierce", baseValue: [80, 1000], scalingRatio: [0.8, 3.5], scalingStat: "strength" }], type: "主动" },
      { name: "嗜灵术", mpCost: [20, 140], cooldown: 4, battleEffects: [{ type: "lifesteal", damageType: "magical", damagePercent: [30, 50] }, { type: "applyStatus", statusType: "mpDrain", tickValue: [4, 6], isPercent: false, duration: 3, maxStacks: 3 }], type: "主动" },
    ...
    "极品": [
      { name: "万象破", mpCost: [35, 220], cooldown: 6, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [160, 1800], scalingRatio: [1.5, 6.0], scalingStat: "strength" }], type: "主动" },
      { name: "万象术", mpCost: [35, 220], cooldown: 6, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [160, 1800], scalingRatio: [1.5, 6.0], scalingStat: "perception" }], type: "主动" },
      { name: "起死回生", mpCost: [50, 300], cooldown: 6, battleEffects: [{ type: "revive", hpPercent: 50 }], type: "主动" },
      { name: "斩杀术", mpCost: [38, 240], cooldown: 6, battleEffects: [{ type: "dealDamageExecute", damageType: "physical", baseValue: [150, 1800], scalingRatio: [1.0, 5.0], scalingStat: "strength", threshold: 0.5, bonusPercent: 50 }], type: "主动" },
      { name: "隐遁术", mpCost: [40, 260], cooldown: 6, battleEffects: [{ type: "stealth", duration: 2 }, { type: "dealDamage", damageType: "physical", baseValue: [120, 1500], scalingRatio: [1.0, 5.0], scalingStat: "strength" }], type: "主动" },
    ...
    "仙品": [
      { name: "万法归宗·武", mpCost: [55, 340], cooldown: 8, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [250, 2500], scalingRatio: [1.8, 8.0], scalingStat: "strength" }], type: "主动" },
      { name: "万法归宗·法", mpCost: [55, 340], cooldown: 8, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [250, 2500], scalingRatio: [1.8, 8.0], scalingStat: "perception" }], type: "主动" },
      { name: "天道净化", mpCost: [60, 360], cooldown: 8, battleEffects: [{ type: "cleanse" }, { type: "shield", baseValue: [200, 2000], scalingRatio: [0.5, 3.0], scalingStat: "perception" }], type: "主动" },
      { name: "万法封印", mpCost: [60, 360], cooldown: 8, battleEffects: [{ type: "applyCc", ccType: "silence", chance: [0.40, 0.60], duration: 2 }, { type: "applyCc", ccType: "freeze", chance: [0.35, 0.55], duration: 1 }], type: "主动" },
      { name: "神速术", mpCost: [55, 340], cooldown: 8, battleEffects: [{ type: "extraAction", chance: 0.15 }, { type: "gaugeManipulate", value: -20 }], type: "主动" },
    ...
    "神品": [
      { name: "万道归一·武", mpCost: [90, 550], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [400, 4000], scalingRatio: [2.0, 10.0], scalingStat: "strength" }], type: "主动" },
      { name: "万道归一·法", mpCost: [90, 550], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [400, 4000], scalingRatio: [2.0, 10.0], scalingStat: "perception" }], type: "主动" },
      { name: "轮回逆转", mpCost: [120, 700], cooldown: 10, battleEffects: [{ type: "revive", hpPercent: 70 }, { type: "shield", baseValue: [500, 5000], scalingRatio: [0.5, 4.0], scalingStat: "perception" }], type: "主动" },
      { name: "万道封魔", mpCost: [110, 660], cooldown: 10, battleEffects: [{ type: "applyCc", ccType: "confusion", chance: [0.35, 0.55], duration: 2 }, { type: "applyCc", ccType: "fear", chance: [0.35, 0.55], duration: 1 }, { type: "applyCc", ccType: "taunt", chance: [0.45, 0.70], duration: 2 }], type: "主动" },
      { name: "万灵召唤", mpCost: [100, 600], cooldown: 10, battleEffects: [{ type: "summon", name: "灵体", trigger: "on_turn_end", summonDamage: [200, 2500], duration: 5 }], type: "主动" },
  ...
  "剑修": {
    "下品": [
      { name: "基础剑法", mpCost: [3, 20], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [50, 600], scalingRatio: [1.0, 4.0], scalingStat: "strength" }], type: "主动" },
      { name: "追风剑", mpCost: [5, 30], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [40, 500], scalingRatio: [0.6, 2.5], scalingStat: "strength" }, { type: "applyModifier", modifierType: "critRate", value: [8, 15], duration: 2, maxStacks: 1, targetSelf: true }], type: "主动" },
      { name: "破甲剑", mpCost: [4, 25], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [40, 500], scalingRatio: [0.6, 2.5], scalingStat: "strength" }, { type: "applyModifier", modifierType: "physDefensePenetration", value: [10, 20], duration: 2, maxStacks: 1, targetSelf: true }], type: "主动" },
    ...
    "中品": [
      { name: "疾风剑", mpCost: [8, 60], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [80, 1000], scalingRatio: [1.2, 5.0], scalingStat: "strength" }], type: "主动" },
      { name: "致命突刺", mpCost: [10, 70], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [60, 800], scalingRatio: [0.8, 3.5], scalingStat: "strength" }, { type: "applyModifier", modifierType: "critRate", value: [10, 18], duration: 2, maxStacks: 1, targetSelf: true }], type: "主动" },
      { name: "连环剑", mpCost: [10, 80], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [50, 700], scalingRatio: [0.5, 2.5], scalingStat: "strength" }, { type: "extraAction", chance: 0.10 }], type: "主动" },
    ...
    "上品": [
      { name: "万剑诀", mpCost: [15, 120], cooldown: 4, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [120, 1500], scalingRatio: [1.5, 6.0], scalingStat: "strength" }], type: "主动" },
      { name: "剑气纵横", mpCost: [15, 120], cooldown: 4, battleEffects: [{ type: "dealDamagePierce", baseValue: [100, 1200], scalingRatio: [1.0, 4.0], scalingStat: "strength" }], type: "主动" },
      { name: "御剑术", mpCost: [18, 130], cooldown: 4, battleEffects: [{ type: "summon", name: "飞剑", trigger: "on_attack", summonDamage: [60, 800], duration: 3 }], type: "主动" },
    ...
    "极品": [
      { name: "天剑诀", mpCost: [30, 200], cooldown: 6, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [200, 2200], scalingRatio: [1.8, 7.5], scalingStat: "strength" }], type: "主动" },
      { name: "一剑封喉", mpCost: [32, 210], cooldown: 6, battleEffects: [{ type: "dealDamageExecute", damageType: "physical", baseValue: [180, 2000], scalingRatio: [1.2, 5.0], scalingStat: "strength", threshold: 0.5, bonusPercent: 50 }], type: "主动" },
      { name: "御剑·万剑归宗", mpCost: [38, 250], cooldown: 6, battleEffects: [{ type: "summon", name: "飞剑", trigger: "on_attack", summonDamage: [120, 1500], duration: 4 }, { type: "extraAction", chance: 0.15 }], type: "主动" },
    ...
    "仙品": [
      { name: "诛仙剑", mpCost: [50, 300], cooldown: 8, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [300, 3000], scalingRatio: [2.0, 9.0], scalingStat: "strength" }], type: "主动" },
      { name: "一剑万杀", mpCost: [55, 340], cooldown: 8, battleEffects: [{ type: "dealDamageExecute", damageType: "physical", baseValue: [250, 2800], scalingRatio: [1.0, 5.0], scalingStat: "strength", threshold: 0.4, bonusPercent: 60 }, { type: "applyModifier", modifierType: "critRate", value: [15, 25], duration: 2, maxStacks: 1, targetSelf: true }], type: "主动" },
      { name: "剑影遁形", mpCost: [50, 320], cooldown: 8, battleEffects: [{ type: "stealth", duration: 2 }, { type: "dealDamage", damageType: "physical", baseValue: [200, 2500], scalingRatio: [1.0, 5.0], scalingStat: "strength" }], type: "主动" },
    ...
    "神品": [
      { name: "开天一剑", mpCost: [80, 500], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [500, 5000], scalingRatio: [2.5, 12.0], scalingStat: "strength" }], type: "主动" },
      { name: "诛仙·万剑归宗", mpCost: [100, 600], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [300, 4000], scalingRatio: [0.8, 5.0], scalingStat: "strength" }, { type: "summon", name: "飞剑", trigger: "on_crit", summonDamage: [200, 3000], duration: 4 }, { type: "extraAction", chance: 0.20 }], type: "主动" },
      { name: "一剑破万法", mpCost: [100, 600], cooldown: 10, battleEffects: [{ type: "dealDamagePierce", baseValue: [400, 5000], scalingRatio: [1.5, 8.0], scalingStat: "strength" }, { type: "gaugeManipulate", value: -30 }], type: "主动" },
  ...
  "体修": {
    "下品": [
      { name: "铁拳碎岩", mpCost: [3, 20], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [50, 600], scalingRatio: [1.0, 4.0], scalingStat: "strength" }], type: "主动" },
      { name: "碎骨拳", mpCost: [5, 30], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [40, 500], scalingRatio: [0.6, 2.5], scalingStat: "strength" }, { type: "applyStatus", statusType: "bleed", tickValue: [20, 200], isPercent: false, duration: 3, maxStacks: 3 }], type: "主动" },
      { name: "震击", mpCost: [4, 25], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [40, 500], scalingRatio: [0.6, 2.5], scalingStat: "strength" }, { type: "applyCc", ccType: "stun", chance: [0.15, 0.30], duration: 1 }], type: "主动" },
    ...
    "中品": [
      { name: "崩山击", mpCost: [8, 60], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [80, 1000], scalingRatio: [1.2, 5.0], scalingStat: "strength" }], type: "主动" },
      ...
      { name: "擒拿手", mpCost: [10, 70], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [50, 700], scalingRatio: [0.5, 2.5], scalingStat: "strength" }, { type: "applyCc", ccType: "taunt", chance: [0.50, 0.80], duration: 2 }], type: "主动" },
    ...
    "上品": [
      { name: "山岳投", mpCost: [15, 120], cooldown: 4, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [120, 1500], scalingRatio: [1.5, 6.0], scalingStat: "strength" }], type: "主动" },
      { name: "嗜血重击", mpCost: [15, 120], cooldown: 4, battleEffects: [{ type: "lifesteal", damageType: "physical", damagePercent: [40, 60] }], type: "主动" },
      { name: "霸王击", mpCost: [18, 140], cooldown: 4, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [80, 1000], scalingRatio: [0.5, 3.0], scalingStat: "strength" }, { type: "applyCc", ccType: "stun", chance: [0.30, 0.55], duration: 1 }, { type: "gaugeManipulate", value: -20 }], type: "主动" },
    ...
    "极品": [
      { name: "涅槃击", mpCost: [30, 200], cooldown: 6, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [200, 2200], scalingRatio: [1.8, 7.5], scalingStat: "strength" }], type: "主动" },
      { name: "天罡怒", mpCost: [35, 240], cooldown: 6, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [120, 1500], scalingRatio: [0.4, 2.5], scalingStat: "strength" }, { type: "applyCc", ccType: "stun", chance: [0.35, 0.65], duration: 1 }, { type: "gaugeManipulate", value: -30 }], type: "主动" },
      { name: "斩魂击", mpCost: [35, 220], cooldown: 6, battleEffects: [{ type: "dealDamageExecute", damageType: "physical", baseValue: [150, 1800], scalingRatio: [0.8, 4.0], scalingStat: "strength", threshold: 0.5, bonusPercent: 50 }], type: "主动" },
    ...
    "仙品": [
      { name: "金身怒目", mpCost: [50, 300], cooldown: 8, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [300, 3000], scalingRatio: [2.0, 9.0], scalingStat: "strength" }], type: "主动" },
      { name: "灭世碎空拳", mpCost: [60, 360], cooldown: 8, battleEffects: [{ type: "dealDamageExecute", damageType: "physical", baseValue: [200, 2500], scalingRatio: [0.5, 3.5], scalingStat: "strength", threshold: 0.5, bonusPercent: 50 }, { type: "applyModifier", modifierType: "damageDealt", value: [30, 60], duration: 2, maxStacks: 3, targetSelf: true }], type: "主动" },
      { name: "血魔吞天", mpCost: [55, 340], cooldown: 8, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [200, 2500], scalingRatio: [0.8, 4.0], scalingStat: "strength" }, { type: "lifesteal", damageType: "physical", damagePercent: [50, 75] }], type: "主动" },
    ...
    "神品": [
      { name: "涅槃重生击", mpCost: [80, 500], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [500, 5000], scalingRatio: [2.5, 12.0], scalingStat: "strength" }], type: "主动" },
      { name: "混沌灭世击", mpCost: [100, 600], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "physical", baseValue: [300, 4000], scalingRatio: [0.8, 5.0], scalingStat: "strength" }, { type: "applyStatus", statusType: "bleed", tickValue: [100, 800], isPercent: false, duration: 3, maxStacks: 5 }, { type: "applyCc", ccType: "stun", chance: [0.40, 0.75], duration: 1 }], type: "主动" },
      { name: "天崩地裂", mpCost: [100, 600], cooldown: 10, battleEffects: [{ type: "dealDamageExecute", damageType: "physical", baseValue: [300, 3500], scalingRatio: [0.6, 4.0], scalingStat: "strength", threshold: 0.4, bonusPercent: 60 }, { type: "applyCc", ccType: "stun", chance: [0.40, 0.70], duration: 1 }, { type: "gaugeManipulate", value: -40 }], type: "主动" },
  ...
  "法修": {
    "下品": [
      { name: "法弹术", mpCost: [10, 60], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [50, 600], scalingRatio: [1.0, 4.0], scalingStat: "perception" }], type: "主动" },
      { name: "火球术", mpCost: [8, 50], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [40, 500], scalingRatio: [0.6, 2.5], scalingStat: "perception" }, { type: "applyStatus", statusType: "burn", tickValue: [20, 200], isPercent: false, duration: 3, maxStacks: 3 }], type: "主动" },
      { name: "寒冰刺", mpCost: [8, 50], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [40, 500], scalingRatio: [0.6, 2.5], scalingStat: "perception" }, { type: "applyCc", ccType: "freeze", chance: [0.15, 0.30], duration: 1 }], type: "主动" },
    ...
    "中品": [
      { name: "灵海冲击", mpCost: [20, 120], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [80, 1000], scalingRatio: [1.2, 5.0], scalingStat: "perception" }], type: "主动" },
      { name: "灼魂术", mpCost: [25, 150], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [60, 800], scalingRatio: [0.5, 3.0], scalingStat: "perception" }, { type: "applyStatus", statusType: "burn", tickValue: [40, 400], isPercent: false, duration: 3, maxStacks: 5 }], type: "主动" },
      { name: "寂静术", mpCost: [20, 130], cooldown: 2, battleEffects: [{ type: "applyCc", ccType: "silence", chance: [0.45, 0.70], duration: 2 }, { type: "dealDamage", damageType: "magical", baseValue: [50, 700], scalingRatio: [0.4, 2.0], scalingStat: "perception" }], type: "主动" },
    ...
    "上品": [
      { name: "灵元爆发", mpCost: [40, 240], cooldown: 4, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [120, 1500], scalingRatio: [1.5, 6.0], scalingStat: "perception" }], type: "主动" },
      { name: "冰封禁制", mpCost: [35, 200], cooldown: 4, battleEffects: [{ type: "applyCc", ccType: "freeze", chance: [0.50, 0.80], duration: 2 }, { type: "applyModifier", modifierType: "magDamageDealt", value: [30, 55], duration: 2, maxStacks: 1, targetSelf: true }], type: "主动" },
      { name: "破灭术", mpCost: [35, 220], cooldown: 4, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [100, 1200], scalingRatio: [0.8, 4.0], scalingStat: "perception" }, { type: "applyModifier", modifierType: "magDefensePenetration", value: [15, 25], duration: 2, maxStacks: 1, targetSelf: true }], type: "主动" },
    ...
    "极品": [
      { name: "太虚法印", mpCost: [70, 400], cooldown: 6, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [200, 2200], scalingRatio: [1.8, 7.5], scalingStat: "perception" }], type: "主动" },
      { name: "雷火双诀", mpCost: [60, 360], cooldown: 6, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [150, 1800], scalingRatio: [0.4, 3.0], scalingStat: "perception" }, { type: "applyStatus", statusType: "burn", tickValue: [60, 500], isPercent: false, duration: 3, maxStacks: 5 }, { type: "applyCc", ccType: "silence", chance: [0.30, 0.50], duration: 1 }], type: "主动" },
      { name: "湮灭术", mpCost: [65, 380], cooldown: 6, battleEffects: [{ type: "dealDamageExecute", damageType: "magical", baseValue: [180, 2000], scalingRatio: [1.0, 5.0], scalingStat: "perception", threshold: 0.5, bonusPercent: 50 }], type: "主动" },
    ...
    "仙品": [
      { name: "神机法", mpCost: [100, 600], cooldown: 8, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [300, 3000], scalingRatio: [2.0, 9.0], scalingStat: "perception" }], type: "主动" },
      { name: "焚天烈焰", mpCost: [90, 520], cooldown: 8, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [250, 2800], scalingRatio: [0.8, 4.0], scalingStat: "perception" }, { type: "applyStatus", statusType: "burn", tickValue: [80, 800], isPercent: false, duration: 4, maxStacks: 8 }], type: "主动" },
      { name: "万象冰封", mpCost: [85, 500], cooldown: 8, battleEffects: [{ type: "applyCc", ccType: "freeze", chance: [0.60, 0.85], duration: 2 }, { type: "gaugeManipulate", value: -30 }, { type: "dealDamage", damageType: "magical", baseValue: [150, 1800], scalingRatio: [0.4, 2.0], scalingStat: "perception" }], type: "主动" },
    ...
    "神品": [
      { name: "万法之源", mpCost: [150, 800], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [500, 5000], scalingRatio: [2.5, 12.0], scalingStat: "perception" }], type: "主动" },
      { name: "混元一气", mpCost: [120, 720], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [400, 4500], scalingRatio: [0.6, 4.0], scalingStat: "perception" }, { type: "lifesteal", damageType: "magical", damagePercent: [50, 80] }, { type: "applyModifier", modifierType: "magDamageDealt", value: [40, 70], duration: 3, maxStacks: 3, targetSelf: true }], type: "主动" },
      { name: "天火焚世", mpCost: [130, 760], cooldown: 10, battleEffects: [{ type: "dealDamageExecute", damageType: "magical", baseValue: [400, 5000], scalingRatio: [1.0, 6.0], scalingStat: "perception", threshold: 0.4, bonusPercent: 60 }, { type: "applyStatus", statusType: "burn", tickValue: [100, 1000], isPercent: false, duration: 4, maxStacks: 10 }, { type: "applyCc", ccType: "silence", chance: [0.40, 0.65], duration: 1 }], type: "主动" },
  ...
  "毒修": {
    "下品": [
      { name: "毒雾术", mpCost: [10, 60], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [50, 600], scalingRatio: [1.0, 4.0], scalingStat: "perception" }], type: "主动" },
      { name: "蚀骨毒", mpCost: [8, 50], cooldown: 1, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [40, 500], scalingRatio: [0.6, 2.5], scalingStat: "perception" }, { type: "applyStatus", statusType: "poison", tickValue: [20, 200], isPercent: false, duration: 3, maxStacks: 3 }], type: "主动" },
    ...
    "中品": [
      { name: "蛊毒术", mpCost: [20, 120], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [80, 1000], scalingRatio: [1.2, 5.0], scalingStat: "perception" }], type: "主动" },
      { name: "腐蚀毒", mpCost: [22, 140], cooldown: 2, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [60, 800], scalingRatio: [0.5, 3.0], scalingStat: "perception" }, { type: "applyStatus", statusType: "poison", tickValue: [30, 400], isPercent: false, duration: 3, maxStacks: 5 }], type: "主动" },
      { name: "噬魂毒", mpCost: [20, 130], cooldown: 2, battleEffects: [{ type: "applyStatus", statusType: "mpDrain", tickValue: [5, 8], isPercent: false, duration: 3, maxStacks: 3 }, { type: "applyCc", ccType: "fear", chance: [0.30, 0.50], duration: 1 }], type: "主动" },
    ...
    "上品": [
      { name: "百毒穿心", mpCost: [40, 240], cooldown: 4, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [120, 1500], scalingRatio: [1.5, 6.0], scalingStat: "perception" }], type: "主动" },
      { name: "剧毒之域", mpCost: [38, 230], cooldown: 4, battleEffects: [{ type: "applyStatus", statusType: "poison", tickValue: [5, 12], isPercent: true, duration: 4, maxStacks: 8 }, { type: "applyStatus", statusType: "bleed", tickValue: [50, 500], isPercent: false, duration: 3, maxStacks: 5 }], type: "主动" },
      { name: "幻毒术", mpCost: [35, 220], cooldown: 4, battleEffects: [{ type: "applyCc", ccType: "confusion", chance: [0.40, 0.60], duration: 2 }, { type: "applyCc", ccType: "fear", chance: [0.35, 0.55], duration: 1 }, { type: "dealDamage", damageType: "magical", baseValue: [60, 800], scalingRatio: [0.4, 2.0], scalingStat: "perception" }], type: "主动" },
    ...
    "极品": [
      { name: "天毒破", mpCost: [70, 400], cooldown: 6, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [200, 2200], scalingRatio: [1.8, 7.5], scalingStat: "perception" }], type: "主动" },
      { name: "九幽蚀魂", mpCost: [65, 380], cooldown: 6, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [150, 1800], scalingRatio: [0.5, 3.0], scalingStat: "perception" }, { type: "applyStatus", statusType: "poison", tickValue: [8, 18], isPercent: true, duration: 4, maxStacks: 10 }, { type: "applyStatus", statusType: "mpDrain", tickValue: [8, 12], isPercent: false, duration: 3, maxStacks: 5 }], type: "主动" },
      { name: "噬灵毒蛊", mpCost: [60, 360], cooldown: 6, battleEffects: [{ type: "lifesteal", damageType: "magical", damagePercent: [45, 65] }, { type: "applyStatus", statusType: "poison", tickValue: [6, 14], isPercent: true, duration: 3, maxStacks: 5 }], type: "主动" },
    ...
    "仙品": [
      { name: "天毒灭世", mpCost: [100, 600], cooldown: 8, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [300, 3000], scalingRatio: [2.0, 9.0], scalingStat: "perception" }], type: "主动" },
      { name: "毒龙噬天", mpCost: [90, 520], cooldown: 8, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [250, 2800], scalingRatio: [0.8, 4.0], scalingStat: "perception" }, { type: "lifesteal", damageType: "magical", damagePercent: [50, 75] }, { type: "applyStatus", statusType: "poison", tickValue: [10, 22], isPercent: true, duration: 4, maxStacks: 12 }], type: "主动" },
      { name: "万蛊噬心", mpCost: [85, 500], cooldown: 8, battleEffects: [{ type: "applyStatus", statusType: "poison", tickValue: [12, 25], isPercent: true, duration: 5, maxStacks: 15 }, { type: "applyStatus", statusType: "bleed", tickValue: [100, 1000], isPercent: false, duration: 4, maxStacks: 8 }, { type: "applyCc", ccType: "confusion", chance: [0.40, 0.60], duration: 2 }], type: "主动" },
    ...
    "神品": [
      { name: "天道毒灭", mpCost: [150, 800], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [500, 5000], scalingRatio: [2.5, 12.0], scalingStat: "perception" }], type: "主动" },
      { name: "万毒归宗", mpCost: [130, 760], cooldown: 10, battleEffects: [{ type: "dealDamage", damageType: "magical", baseValue: [350, 4500], scalingRatio: [0.8, 5.0], scalingStat: "perception" }, { type: "applyStatus", statusType: "poison", tickValue: [15, 30], isPercent: true, duration: 5, maxStacks: 20 }, { type: "applyStatus", statusType: "bleed", tickValue: [150, 1500], isPercent: false, duration: 4, maxStacks: 10 }, { type: "applyCc", ccType: "fear", chance: [0.45, 0.70], duration: 2 }], type: "主动" },
      { name: "噬天毒蛊", mpCost: [120, 720], cooldown: 10, battleEffects: [{ type: "lifesteal", damageType: "magical", damagePercent: [60, 85] }, { type: "applyStatus", statusType: "poison", tickValue: [12, 28], isPercent: true, duration: 5, maxStacks: 15 }, { type: "applyStatus", statusType: "mpDrain", tickValue: [12, 18], isPercent: false, duration: 3, maxStacks: 8 }, { type: "applyCc", ccType: "confusion", chance: [0.40, 0.65], duration: 2 }], type: "主动" },
